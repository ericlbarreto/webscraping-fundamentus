class FundoImobiliario:  # CLASSE COM TODOS OS ELEMENTOS DE UM FUNDO IMOBILIÁRIO
...
class Estrategia:  # CLASSE COM TODOS OS VALORES MÍNIMOS DO FILTRO ESTRATÉGICO
    def __init__(self, segmento='', cotacao_atual_minima=0, ffo_yield_minimo=0, dividend_yield_minimo=0, p_vp_minimo=0,
                 ...
                 valor_minimo_aluguel=0, valor_minimo_cap_rate=0, maxima_vacancia_media=0):
        self.segmento = segmento
        ...
        self.valor_minimo_aluguel_m2 = valor_minimo_aluguel
        self.valor_minimo_cap_rate = valor_minimo_cap_rate
        self.maxima_vacancia_media = maxima_vacancia_media

    def aplica_estrategia(self, fundo: FundoImobiliario):  # FUNÇÃO QUE APLICA A ESTRATÉGIA RETORNANDO TRUE OR FALSE
        if self.segmento != '':
